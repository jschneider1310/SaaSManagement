...
using SaaSManagement.Web.Components.Account.Pages;
using SaaSManagement.Web.Components.Account.Pages.Manage;
...
internal static class IdentityComponentsEndpointRouteBuilderExtensions
{
        ...
        this IEndpointRouteBuilder endpoints)
    {
        ...
        accountGroup.MapPost("/PasskeyCreationOptions",
                ...
                [FromServices] IAntiforgery antiforgery) =>
            {
                ...
                var optionsJson = await signInManager.MakePasskeyCreationOptionsAsync(
                    new() { Id = userId, Name = userName, DisplayName = userName });

                return TypedResults.Content(optionsJson, contentType: "application/json");
            });

        accountGroup.MapPost("/PasskeyRequestOptions",
            async (HttpContext context,
                [FromServices] UserManager<ApplicationUser> userManager,
                [FromServices] SignInManager<ApplicationUser> signInManager,
                [FromServices] IAntiforgery antiforgery, [FromQuery] string? username) =>
            {
                await antiforgery.ValidateRequestAsync(context);
