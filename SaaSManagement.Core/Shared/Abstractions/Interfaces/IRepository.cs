...
public interface IRepository<T, in TId> where T : Entity<TId>
{
    ...
    ValueTask<Result<List<T>>> AddRangeAsync(IEnumerable<T> entities, CancellationToken cancellationToken = default);
    /// <summary>
    /// Updates a T entity
    /// </summary>
    ...
    ValueTask<Result<List<T>>> UpdateRangeAsync(IEnumerable<T> entities, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <param name="cancellationToken"><see cref="CancellationToken"/></param>
    /// <returns>True if the entity was successfully deleted, and false otherwise.</returns>
    ValueTask<bool> DeleteAsync(TId entityId, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <param name="cancellationToken"><see cref="CancellationToken"/></param>
    /// <returns>True if the operation succeed, and false otherwise.</returns>
    ValueTask<bool> DeleteRangeAsync(IEnumerable<T> entities, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    ValueTask<Result<IEnumerable<T>?>> GetAllAsync(CancellationToken cancellationToken = default);
    /// <summary>
    ...
    ValueTask<Result<IEnumerable<T>?>> GetAllAsync(Expression<Func<T, bool>> predicate, CancellationToken cancellationToken = default);
}